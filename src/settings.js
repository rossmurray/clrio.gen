const settings = {
    ...
    marginPercent: 0.05,
    panels: {
        sizeVariation: 1.1, //higher = smallest and largest panels are more different. 2 = the largest panel could be double the average.
        ...
        maxSpeed: {min: 0.09, max: 0.6}, //fastest a panel can move, varying on panel value. 0 = cannot move. 1 = can travel the screen in 1 second.
        ...
        marginPercent: 0.05,
        count: 40,
        visualDensityPercent: 1.1, //percentage of total area matched by area of panels (assuming no overlap)
        emptyGridPercent: 0.3, //what percentage of slots are not occupied by panels at any given time
        color1: "#c20a02", //red
