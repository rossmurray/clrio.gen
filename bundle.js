...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateSliders(sliders, boundary) {
	    ...
	    var hueMod = (0, _wave2.default)(function (x) {
	        return _wave2.default.sine(_wave2.default.time(1 / 3));
	    });
	    ...
	    var hueF = (0, _wave2.default)(function (x) {
	        return _wave2.default.reverse(x - _wave2.default.time(1 / 2));
	    }, { min: 0, max: 360, frequency: 1 });
	    ...
	    for (var i = 0; i < sliders.length; i++) {
	        ...
	        var hue = hueF(utility.scaleFrom(slider.y, boundary.y, boundary.y + boundary.height, 0, 1));
	...
	function makeSliders(count, boundary) {
	    ...
	    var heightFunction = (0, _wave2.default)(function (x) {
	        return _wave2.default.reverse(_wave2.default.smooth(x / count));
